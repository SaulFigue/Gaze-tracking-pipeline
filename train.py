...
class Model(FinalModel):
    def __init__(self, modelo: str, learning_rate: float = 0.001, weight_decay: float = 0., k=None, adjust_slope: bool = False, grid_calibration_samples: bool = False, *args, **kwargs):
        super().__init__(modelo, *args, **kwargs)
...
def main(vgg16: bool, resnet50: bool, path_to_data: str, validate_on_person: int, test_on_person: int, learning_rate: float, weight_decay: float, batch_size: int, k: int, adjust_slope: bool, grid_calibration_samples: bool):
    seed_everything(42)
    ...
    model = Model(modelo, learning_rate, weight_decay, k, adjust_slope, grid_calibration_samples)


    """ If you have a gpu device, un comment 'gpus=1' and comment 'move_metrics_to_cpu = True' """
    trainer = Trainer(
        # gpus=1,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--vgg16", type=bool, default=False)
    parser.add_argument("--resnet50", type=bool, default=False)
    ...
    main(args.vgg16, args.resnet50, args.path_to_data, args.validate_on_person, args.test_on_person, args.learning_rate, args.weight_decay, args.batch_size, args.k, args.adjust_slope, args.grid_calibration_samples)
